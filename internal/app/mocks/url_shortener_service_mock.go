...
func (m *MockURLShortenerService) GetAppStatistic(arg0 context.Context) (dto.AppStatisticItem, error) {
	m.ctrl.T.Helper()
...
func (mr *MockURLShortenerServiceMockRecorder) GetAppStatistic(arg0 interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetAppStatistic", reflect.TypeOf((*MockURLShortenerService)(nil).GetAppStatistic), arg0)
}
